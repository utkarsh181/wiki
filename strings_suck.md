...
For character array,
    ...
    strcpy(another_name,"Utkarsh Singh") // Partially possible as another_name[] on time of declaration had size of 7 byte this can be made possible be allocating more storage ie declaring another_name[20] ;
